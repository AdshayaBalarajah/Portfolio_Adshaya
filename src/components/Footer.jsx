...
const socials = [
  {
    label: 'GitHub',
    href: 'https://github.com/AdshayaBalarajah',
    icon: (
  ...
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/adshaya-balarajah-531735285',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <Link to="hero" smooth duration={800} className="cursor-pointer">
          <motion.div whileHover={{ scale: 1.05 }} className="flex items-center gap-3">
            ...
            <span className="text-sm font-medium text-white/40" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
              Adshaya Balarajah
            </span>
          </motion.div>
        </Link>
        ...
        <p className="font-mono text-xs text-white/20 text-center">
          © 2026 Adshaya Balarajah. All rights reserved.
        </p>
          ...
          {socials.map(s => (
            <motion.a
              ...
              onMouseEnter={e => {
                ...
                e.currentTarget.style.boxShadow = '0 0 18px rgba(139,92,246,0.3)';
              }}
              onMouseLeave={e => {
